...
public final class StdOut {
    ...
    public static void println(double x)  { out.format(java.util.Locale.US, "%f\n", x); }
    public static void println(float x)   { out.format(java.util.Locale.US, "%f\n", x); }
    ...
    public static void print(double x)    { out.format(java.util.Locale.US, "%f", x); out.flush(); }
    public static void print(float x)     { out.format(java.util.Locale.US, "%f", x); out.flush(); }
